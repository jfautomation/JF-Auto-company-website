            ...
            <a class="text-dark text-decoration-none" href="<?php echo esc_url('/all-products/?id=' . $product['id']); ?>">
                <div class="d-flex flex-column h-100 justify-content-between align-items-start">
                    ...
                    <div class="card-body w-100 d-flex flex-column mt-4 justify-content-between">
                        <div>
                            <a class="text-dark text-decoration-none product-link" href="<?php echo esc_url('/all-products/?id=' . $product['id']); ?>">
                        ...
                        <div class="mt-1">
                            <a class="small-text category-span text-grey text-decoration-none" href="/<?php echo esc_attr($product['category_url']); ?>">
                                <span><?php echo esc_html($product['category']); ?></span>
                            </a>
                        </div>

                        <div class="w-auto mt-2">
                            <span class="w-auto badge text-success border border-success">
